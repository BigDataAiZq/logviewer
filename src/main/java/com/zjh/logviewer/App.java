...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        Path classRunDir = Paths.get(App.class.getProtectionDomain()
                .getCodeSource()
                .getLocation()
                .toURI());
        // System.out.println(classRunDir);
        if (classRunDir.toString()
                .endsWith(".jar")) {
        ...
        String webappDir = classRunDir.resolve("webapp")
                .toString();
                ...
                .addShutdownHook(new Thread() {
                    ...
                    public void run() {
                        try {
                            tomcat.stop();
                            tomcat.destroy();
                            ClientFactory.closeAllClient();
                        } catch (LifecycleException e) {
                            e.printStackTrace();
                        }
                        SysParam.clearTmpDir();
